        ...
        <div class="container">
            <div class="row">
                <div class="blog-page col-md-12">
                    ...
                    <div class="col-md-9 col-sm-12 blog-right-menu news-category">
                        <?php while ($the_query-> have_posts()) : $the_query->the_post(); ?>
                            ...
                            <div class="col-md-12 shops">
                                <div class="blog-news">
                                    ...
                                    <div class="col-md-12">
                                        <a href="<?php echo get_permalink($post->ID) ;?>"><h2 class="tac news-header"><?php the_title() ;?></h2></a>
                                        <p class="tac"><?php the_excerpt(); ?></p>
                                    </div>
                                </div>
                            </div>
                        <?php endwhile; ?>
