            ...
            <div class="row">
                <div class="col-xs-5 col-md-5">
                    <ul class="header-left-menu">
                        <li><a href="<?php echo get_permalink(42) ;?>">About us</a></li>
                        <li><a href="<?php echo get_permalink(98) ;?>">Plaza 2</a></li>
                    </ul>
                </div>
                ...
                <div class="col-xs-5 col-md-5">
                    <ul class="header-right-menu">
                        <li>
                            <a class="header-menu-contacts" href="<?php echo get_permalink(62) ;?>">
