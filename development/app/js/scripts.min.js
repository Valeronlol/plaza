...
t.$dots&&t.$dots.remove(),t.$prevArrow&&t.htmlExpr.test(t.options.prevArrow)&&t.$prevArrow.remove(),t.$nextArrow&&t.htmlExpr.test(t.options.nextArrow)&&t.$nextArrow.remove(),t.$slides.removeClass("slick-slide slick-active slick-visible slick-current").attr("aria-hidden","true").css("width","")},t.prototype.unslick=function(e){var t=this;t.$slider.trigger("unslick",[t,e]),t.destroy()},t.prototype.updateArrows=function(){var e=this;Math.floor(e.options.slidesToShow/2),e.options.arrows===!0&&e.slideCount>e.options.slidesToShow&&!e.options.infinite&&(e.$prevArrow.removeClass("slick-disabled").attr("aria-disabled","false"),e.$nextArrow.removeClass("slick-disabled").attr("aria-disabled","false"),0===e.currentSlide?(e.$prevArrow.addClass("slick-disabled").attr("aria-disabled","true"),e.$nextArrow.removeClass("slick-disabled").attr("aria-disabled","false")):e.currentSlide>=e.slideCount-e.options.slidesToShow&&e.options.centerMode===!1?(e.$nextArrow.addClass("slick-disabled").attr("aria-disabled","true"),e.$prevArrow.removeClass("slick-disabled").attr("aria-disabled","false")):e.currentSlide>=e.slideCount-1&&e.options.centerMode===!0&&(e.$nextArrow.addClass("slick-disabled").attr("aria-disabled","true"),e.$prevArrow.removeClass("slick-disabled").attr("aria-disabled","false")))},t.prototype.updateDots=function(){var e=this;null!==e.$dots&&(e.$dots.find("li").removeClass("slick-active").attr("aria-hidden","true"),e.$dots.find("li").eq(Math.floor(e.currentSlide/e.options.slidesToScroll)).addClass("slick-active").attr("aria-hidden","false"))},t.prototype.visibility=function(){var e=this;e.options.autoplay&&(document[e.hidden]?e.interrupted=!0:e.interrupted=!1)},e.fn.slick=function(){var e,n,i=this,o=arguments[0],r=Array.prototype.slice.call(arguments,1),s=i.length;for(e=0;s>e;e++)if("object"==typeof o||void 0===o?i[e].slick=new t(i[e],o):n=i[e].slick[o].apply(i[e].slick,r),void 0!==n)return n;return i}}),$(function(){$("#searchform_fa").on("click",function(){$(this).children("form").trigger("submit")}),$("#searchform input").on("click",function(){return!1}),$(".slick-single").slick({dots:!0,infinite:!0,slidesToShow:1,slidesToScroll:1,speed:700}),$(".main-slider").slick({dots:!1,infinite:!0,slidesToShow:1,slidesToScroll:1,speed:700,arrows:!1,autoplay:!0,autoplaySpeed:5e3}),$(".news-category").slick({dots:!1,infinite:!0,slidesToShow:3,slidesToScroll:1,speed:700,arrows:!0,autoplay:!0,autoplaySpeed:5e3,responsive:[{breakpoint:992,settings:{slidesToShow:2}},{breakpoint:768,settings:{slidesToShow:1}}]}),$("#bottom_menu .container li a").on("mouseenter",function(){$(this).addClass("svg-color")}).on("mouseleave",function(){$(this).removeClass("svg-color")})}),window.innerWidth>992){var floorButtons=$(".floors-button");floorButtons.on("click",function(){$(".floors-cont").css({display:"none"}),floorButtons.removeClass("active"),$(this).addClass("active");var e=$(this).attr("data-href");floorLift(e),changeLiftInfo(e)}),$(window).on("scroll",function(){setScroll()}),setScroll()}